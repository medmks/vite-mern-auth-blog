...
var m = class _m {
  ...
  render() {
    ...
    const { html: t } = _m.services[this.data.service], i = document.createElement("div"), e = document.createElement("div"), s = document.createElement("template"), n = this.createPreloader();
   ...
   */
  onPaste(t) {
    const { key: i, data: e } = t.detail, { regex: s, embedUrl: n, width: r, height: a, id: l = (c) => c.shift() } = _m.services[i], d = s.exec(e).slice(1), h = n.replace(/<%= remote_id %>/g, l(d));
    this.data = {
      service: i,
      source: e,
      embed: h,
  ...
  static prepare({ config: t = {} }) {
    ...
    const s = Object.entries(i).filter(([r, a]) => typeof a == "boolean" && a === true).map(([r]) => r), n = Object.entries(i).filter(([r, a]) => typeof a == "object").filter(([r, a]) => _m.checkServiceConfig(a)).map(([r, a]) => {
    ...
    s.length && (e = e.filter(([r]) => s.includes(r))), e = e.concat(n), _m.services = e.reduce((r, [a, l]) => a in r ? (r[a] = Object.assign({}, r[a], l), r) : (r[a] = l, r), {}), _m.patterns = e.reduce((r, [a, l]) => (r[a] = l.regex, r), {});
  }
  /**
  ...
  static checkServiceConfig(t) {
    ...
    return l = l && (a !== void 0 ? a instanceof Function : true), l = l && (n !== void 0 ? Number.isFinite(n) : true), l = l && (r !== void 0 ? Number.isFinite(r) : true), l;
  }
  /**
