...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="navbar">
          ...
          <Link  className="flex-none  w-11" to={"/"}><img src={logo} alt="" className="w-full " /></Link>
          <div className={" absolute bg-white w-full left-0 top-full mt-0.! border-b border-grey py-4 px-[5vw] md:border-0  md:block md:relative md:inset-0 md:p-0 md:w-auto md:show " +(ToggleSearch ? "show": "hide")}>
                    <input
                    type="text"
